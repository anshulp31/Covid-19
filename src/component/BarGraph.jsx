...
const BarGraph = ({ data }) => {
  ...
  return (
    <div className="bg-white shadow overflow-hidden sm:rounded-lg absolute left-28 top-64">
      <div className="px-4 py-5 sm:px-6">
        <h3 className="text-lg font-medium leading-6 text-gray-900">COVID-19 Statistics by State</h3>
      </div>
